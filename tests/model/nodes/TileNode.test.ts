...
describe('TileNode', () => {
  ...
  describe('ExtraSize', () => {
    it('should default to 0', () => {
      ...
      const childFrameRect = <Rectangle>{ x: 0, y: 0, width: 100, height: 100 };
    ...
    it('should allow child node to have its own unique extraSize', () => {
      ...
      const childFrameRect1 = <Rectangle>{ x: 0, y: 0, width: 100, height: 100 };
      const childSyncedFrame1 = new SyncedFrame(childFrameRect1);
      const childNode1 = new TestSyncedFrameNode(childSyncedFrame1);
      rootNode.addChild(childNode1);

      const childFrameRect2 = <Rectangle>{ x: 50, y: 50, width: 150, height: 150 };
  ...
  describe('doLayout', () => {
    ...
    const arbitraryInitialFrame = <Rectangle>{ x: 0, y: 0, width: 25, height: 75 };

    beforeEach(() => {
      const rootFrameRect = <Rectangle>{ x: 0, y: 0, width: 75, height: 75 };
      const rootSyncedFrame = new SyncedFrame(rootFrameRect);
    ...
    it('should divide and position nodes horizontal', async () => {
      ...
      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 25, height: 75 };
      const expectedChildFrame2 = <Rectangle>{ x: 25, y: 0, width: 25, height: 75 };
      const expectedChildFrame3 = <Rectangle>{ x: 50, y: 0, width: 25, height: 75 };
    ...
    it('should divide and position nodes vertically', async () => {
      ...
      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 75, height: 25 };
      const expectedChildFrame2 = <Rectangle>{ x: 0, y: 25, width: 75, height: 25 };
      const expectedChildFrame3 = <Rectangle>{ x: 0, y: 50, width: 75, height: 25 };
    ...
    it('should utilise innerGaps', async () => {
      ...
      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 19, height: 75 };
      const expectedChildFrame2 = <Rectangle>{ x: 28, y: 0, width: 19, height: 75 };
      const expectedChildFrame3 = <Rectangle>{ x: 56, y: 0, width: 19, height: 75 };
    ...
    it('should utilise extraSize when on the end', async () => {
      ...
      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 35, height: 75 };
      const expectedChildFrame2 = <Rectangle>{ x: 35, y: 0, width: 20, height: 75 };
      const expectedChildFrame3 = <Rectangle>{ x: 55, y: 0, width: 20, height: 75 };
    ...
    it('should utilise extraSize when between siblings', async () => {
      ...
      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 20, height: 75 };
      const expectedChildFrame2 = <Rectangle>{ x: 20, y: 0, width: 35, height: 75 };
      const expectedChildFrame3 = <Rectangle>{ x: 55, y: 0, width: 20, height: 75 };
    ...
    it('should compensate for remainders', async () => {
      const nonDivisbleInitialFrame = <Rectangle>{ x: 0, y: 0, width: 80, height: 80 };
      await rootNode.setFrame(nonDivisbleInitialFrame);

      await rootNode.doLayout();

      const expectedChildFrame1 = <Rectangle>{ x: 0, y: 0, width: 27, height: 80 };
      const expectedChildFrame2 = <Rectangle>{ x: 27, y: 0, width: 27, height: 80 };
      const expectedChildFrame3 = <Rectangle>{ x: 54, y: 0, width: 26, height: 80 };
